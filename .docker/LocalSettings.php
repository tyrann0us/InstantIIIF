...
$wgForeignFileRepos[] = [
    ...
    'hashLevels' => 0,
    # Local image caching is on by default. It is off here so the e2e suite
    # can keep asserting provider hotlink URLs (with caching, thumbnail and
    # full-image URLs point to local /images/iiif-cache/ copies). To test the
    # cached path, set this to e.g. 31536000 and make the thumb zone writable
    # and web-served (point `directory` at $wgUploadDirectory, or add a server
    # alias for the cache URL).
    'imageCacheExpiry' => 0,
    'iiifSources' => [
        [
